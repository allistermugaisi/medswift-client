		...
		<>
						...
						<nav className="hidden md:flex space-x-10">
							<div className="relative">
								...
								<button
									type="button"
									className="
                   group bg-white rounded-md text-gray-600 inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none pb-8'
                  "
									onMouseEnter={() => (
          ...
          */}{' '}
						...
						<div className="hidden md:flex items-center justify-center md:flex-1 lg:w-0">
							<a
								href="#"
								className=" whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-3xl shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700"
							>
								Sign in
							</a>
						</div>
